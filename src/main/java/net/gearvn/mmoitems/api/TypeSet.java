...
public enum TypeSet
{
    SLASHING((cachedStats, obj, weapon, itemAttackResult) -> {
    ...
    PIERCING((cachedStats2, obj2, weapon2, itemAttackResult2) -> {
    ...
    BLUNT((cachedStats3, obj3, weapon3, itemAttackResult3) -> {
        random = new Random();
    ...
    private TypeSet(final SetAttackHandler<PlayerStats.CachedStats, LivingEntity, Weapon, ItemAttackResult> attackHandler) {
