...
public class MMOItems extends LuminePlugin
{
    ...
    @Nullable
    public MMOItem getMMOItem(@Nullable final Type type, @Nullable final String s, @NotNull final PlayerData playerData) {
        if (type == null || s == null) {
            return null;
        }
        ...
        return template.newBuilder(playerData.getRPG()).build();
    }
    
    @Nullable
    public ItemStack getItem(@Nullable final Type type, @Nullable final String s, @NotNull final PlayerData playerData) {
        if (type == null || s == null) {
            return null;
        }
    ...
    @Nullable
    public MMOItem getMMOItem(@Nullable final Type type, @Nullable final String s, final int n, @Nullable final ItemTier itemTier) {
        if (type == null || s == null) {
            return null;
        }
        final MMOItemTemplate template = this.getTemplates().getTemplate(type, s);
    ...
    @Nullable
    public ItemStack getItem(@Nullable final Type type, @Nullable final String s, final int n, @Nullable final ItemTier itemTier) {
        if (type == null || s == null) {
            return null;
        }
    ...
    @Nullable
    public MMOItem getMMOItem(@Nullable final Type type, @Nullable final String s) {
        if (type == null || s == null) {
            return null;
        }
        final MMOItemTemplate template = this.getTemplates().getTemplate(type, s);
    ...
    public ItemStack getItem(@Nullable final String s, @Nullable final String s2) {
        ...
        return this.getItem(this.getType(s), s2);
    }
    ...
    @Nullable
    public Type getType(@Nullable final NBTItem nbtItem) {
        if (nbtItem == null || !nbtItem.hasType()) {
            return null;
        }
        return this.getType(nbtItem.getType());
    }
    
    @Nullable
    public String getID(@Nullable final NBTItem nbtItem) {
        if (nbtItem == null || !nbtItem.hasType()) {
            return null;
        }
        final ItemTag tagAtPath = ItemTag.getTagAtPath("MMOITEMS_ITEM_ID", nbtItem, SupportedNBTTagValues.STRING);
        if (tagAtPath == null) {
            return null;
        }
    ...
    @Nullable
    public Type getType(@Nullable final String s) {
        if (s == null) {
            return null;
        }
        return this.getTypes().get(s);
    }
    ...
    public static boolean isMMOItem(@Nullable final ItemStack itemStack, @NotNull final String anObject, @NotNull final String anObject2) {
        if (itemStack == null) {
            return false;
        }
        final NBTItem value = NBTItem.get(itemStack);
        final String id = MMOItems.plugin.getID(value);
        return id != null && id.equals(anObject2) && value.getType().equals(anObject);
    }
}
