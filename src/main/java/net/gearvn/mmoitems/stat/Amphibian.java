...
public class Amphibian extends ChooseStat implements ItemRestriction, GemStoneStat
{
    ...
    public Amphibian() {
        ...
        Collections.addAll(c, new String[] { "UNRESTRICTED", "DRY", "WET", "DAMP", "LAVA", "MOLTEN", "LIQUID", "SUBMERGED" });
        this.InitializeChooseableList(c);
        final HashMap<String, String> hashMap = new HashMap<String, String>();
        hashMap.put("UNRESTRICTED", "No liquids dependency");
        hashMap.put("DRY", "The item does not work if the player is touching a liquid block.");
        hashMap.put("WET", "The only works if the player is touching water (rain does not count).");
        hashMap.put("DAMP", "The only works if the player is completely submerged in water.");
        hashMap.put("LAVA", "The only works if the player is touching lava.");
        hashMap.put("MOLTEN", "The only works if the player is completely submerged in lava.");
        hashMap.put("LIQUID", "The only works if the player is touching any liquid.");
        hashMap.put("SUBMERGED", "The only works if the player is completely submerged in any liquid.");
