...
public abstract class ItemStat
{
    ...
    String path_Built;
    String nbtPath_Built;
    
    public ItemStat(@NotNull final String id, @NotNull final Material material, @NotNull final String name, final String[] array, final String[] a, final Material... a2) {
        this.enabled = true;
        this.path_Built = null;
        this.nbtPath_Built = null;
        this.id = id;
    ...
    public String getPath() {
        if (this.path_Built != null) {
            return this.path_Built;
        }
        return this.path_Built = this.id.toLowerCase().replace("_", "-");
    }
    
    @NotNull
    public String getNBTPath() {
        if (this.nbtPath_Built != null) {
            return this.nbtPath_Built;
        }
        return this.nbtPath_Built = "MMOITEMS_" + this.id;
    }
