...
public class Crossbow extends UntargetedWeapon
{
    ...
    public void untargetedAttack(final EquipmentSlot equipmentSlot) {
        ...
        MMOItems.plugin.getEntities().registerCustomProjectile(this.getNBTItem(), stats.newTemporary(io.lumine.mythic.lib.api.player.EquipmentSlot.fromBukkit(equipmentSlot)), (Entity)arrow, true);
    }
}
