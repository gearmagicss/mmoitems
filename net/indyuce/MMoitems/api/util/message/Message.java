...
public enum Message
{
    ...
    private static /* synthetic */ Message[] $values() {
        return new Message[] { Message.RECEIVED_ITEM, Message.HANDS_TOO_CHARGED, Message.SPELL_ON_COOLDOWN, Message.ITEM_ON_COOLDOWN, Message.NOT_ENOUGH_PERMS_COMMAND, Message.ATTACK_BLOCKED, Message.ATTACK_DODGED, Message.ATTACK_PARRIED, Message.NOT_ENOUGH_LEVELS, Message.SOULBOUND_RESTRICTION, Message.NOT_ENOUGH_PERMS, Message.WRONG_CLASS, Message.NOT_ENOUGH_MANA, Message.NOT_ENOUGH_STAMINA, Message.NOT_ENOUGH_ATTRIBUTE, Message.NOT_ENOUGH_PROFESSION, Message.UNIDENTIFIED_ITEM, Message.ZERO_DURABILITY, Message.CANNOT_IDENTIFY_STACKED_ITEMS, Message.SUCCESSFULLY_IDENTIFIED, Message.SUCCESSFULLY_DECONSTRUCTED, Message.GEM_STONE_APPLIED, Message.GEM_STONE_BROKE, Message.REPAIRED_ITEM, Message.SKIN_APPLIED, Message.SKIN_REMOVED, Message.SKIN_BROKE, Message.SKIN_REJECTED, Message.SKIN_INCOMPATIBLE, Message.RANDOM_UNSOCKET_GEM_TOO_OLD, Message.RANDOM_UNSOCKET_SUCCESS, Message.CANT_BIND_ITEM, Message.NO_SOULBOUND, Message.CANT_BIND_STACKED, Message.UNSUCCESSFUL_SOULBOUND, Message.UNSUCCESSFUL_SOULBOUND_BREAK, Message.LOW_SOULBOUND_LEVEL, Message.SUCCESSFULLY_BIND_ITEM, Message.SUCCESSFULLY_BREAK_BIND, Message.SOULBOUND_ITEM_LORE, Message.CANT_UPGRADED_STACK, Message.MAX_UPGRADES_HIT, Message.UPGRADE_FAIL, Message.UPGRADE_FAIL_STATION, Message.WRONG_UPGRADE_REFERENCE, Message.UPGRADE_SUCCESS, Message.NOT_HAVE_ITEM_UPGRADE, Message.UPGRADE_REQUIREMENT_SAFE_CHECK, Message.NOT_ENOUGH_MATERIALS, Message.CONDITIONS_NOT_MET, Message.CRAFTING_CANCELED, Message.CRAFTING_QUEUE_FULL, Message.STATION_BIG_STACK, Message.RECIPE_PREVIEW, Message.UNABLE_TO_REPAIR };
    }
