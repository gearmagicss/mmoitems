...
public class DropTable
{
    ...
    public DropTable(final ConfigurationSection configurationSection) {
        ...
        Validate.notNull((Object)configurationSection, "Could not read the drop table config");
        for (final String str : configurationSection.getKeys(false)) {
            try {
                ...
                MMOItems.print(null, "Could not read subtable '$r{0}$b' from drop table '$e{1}$b';&f {2}", str, configurationSection.getName(), ex.getMessage());
            }
        }
