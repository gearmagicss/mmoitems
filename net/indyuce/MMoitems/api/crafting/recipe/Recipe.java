...
public abstract class Recipe
{
    ...
    public abstract CheckedRecipe evaluateRecipe(final PlayerData p0, final IngredientInventory p1);
    ...
    public enum RecipeOption
    {
        ...
        private static /* synthetic */ RecipeOption[] $values() {
            return new RecipeOption[] { RecipeOption.HIDE_WHEN_LOCKED, RecipeOption.HIDE_WHEN_NO_INGREDIENTS, RecipeOption.OUTPUT_ITEM, RecipeOption.SILENT_CRAFT };
        }
