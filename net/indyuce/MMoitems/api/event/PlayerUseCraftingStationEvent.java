...
public class PlayerUseCraftingStationEvent extends PlayerDataEvent
{
    ...
    public enum StationAction
    {
        ...
        private static /* synthetic */ StationAction[] $values() {
            return new StationAction[] { StationAction.INTERACT_WITH_RECIPE, StationAction.INSTANT_RECIPE, StationAction.CRAFTING_QUEUE, StationAction.CANCEL_QUEUE };
        }
