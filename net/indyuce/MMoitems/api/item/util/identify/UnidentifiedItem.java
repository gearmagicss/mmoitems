...
public class UnidentifiedItem extends ConfigItem
{
    ...
    public class ItemBuilder
    {
        ...
        public ItemStack build() {
            ...
            final ItemStack item = MythicLib.plugin.getVersion().getWrapper().copyTexture(this.item).addTag(new ItemTag[] { new ItemTag("MMOITEMS_UNIDENTIFIED_ITEM", (Object)this.serialize(this.item.toItem())) }).toItem();
