...
public interface RPGHandler
{
    ...
    public enum PluginEnum
    {
        ...
        AURELIUM_SKILLS("AureliumSkills", (Class<? extends RPGHandler>)AureliumSkillsHook.class), 
        ...
        private static /* synthetic */ PluginEnum[] $values() {
            return new PluginEnum[] { PluginEnum.MMOCORE, PluginEnum.HEROES, PluginEnum.SKILLAPI, PluginEnum.RPGPLAYERLEVELING, PluginEnum.RACESANDCLASSES, PluginEnum.BATTLELEVELS, PluginEnum.MCMMO, PluginEnum.MCRPG, PluginEnum.SKILLS, PluginEnum.AURELIUM_SKILLS, PluginEnum.SKILLSPRO };
        }
