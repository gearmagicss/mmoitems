...
public class PluginHelp
{
    ...
    public enum PluginCommand
    {
        ...
        private static /* synthetic */ PluginCommand[] $values() {
            return new PluginCommand[] { PluginCommand.OPTIONAL, PluginCommand.REQUIRED, PluginCommand.MULTIPLE_ARGS, PluginCommand.HOVER_COMMAND, PluginCommand.TAB_INFO, PluginCommand.SPACE, PluginCommand.HELP, PluginCommand.GIVE, PluginCommand.GIVEALL, PluginCommand.BROWSE, PluginCommand.GENERATE, PluginCommand.ABILITY, PluginCommand.DROP, PluginCommand.HEAL, PluginCommand.IDENTIFY, PluginCommand.UNIDENTIFY, PluginCommand.REPAIR, PluginCommand.DECONSTRUCT, PluginCommand.INFO, PluginCommand.LIST, PluginCommand.RELOAD, PluginCommand.CREATE, PluginCommand.COPY, PluginCommand.DELETE, PluginCommand.EDIT, PluginCommand.ITEMLIST, PluginCommand.ALLITEMS, PluginCommand.STATIONS_LIST, PluginCommand.STATIONS_OPEN, PluginCommand.UPDATEITEM, PluginCommand.UPDATEITEM_ITEM };
        }
