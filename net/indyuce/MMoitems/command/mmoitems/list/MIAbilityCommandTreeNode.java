...
{
    public MIAbilityCommandTreeNode(final CommandTreeNode commandTreeNode) {
        super(commandTreeNode, "miability");
    }
    
    public CommandTreeNode.CommandResult execute(final CommandSender commandSender, final String[] array) {
        commandSender.sendMessage(ChatColor.DARK_GRAY + "" + ChatColor.STRIKETHROUGH + "-----------------[" + ChatColor.LIGHT_PURPLE + " MMOItems Abilities " + ChatColor.DARK_GRAY + "" + ChatColor.STRIKETHROUGH + "]-----------------");
        ...
        for (final Ability ability : MMOItems.plugin.getAbilities().getAllMMOItemsAbilities()) {
