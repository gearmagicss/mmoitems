...
public class StatManager
{
    ...
    private final Set<PlayerConsumable> playerConsumables;
    @Deprecated
    private final Set<DynamicLoreStat> dynamicLores;
    ...
    public StatManager() {
        ...
        this.playerConsumables = new HashSet<PlayerConsumable>();
        this.dynamicLores = new HashSet<DynamicLoreStat>();
    ...
    public void register(final ItemStat itemStat) {
        ...
        if (itemStat instanceof DynamicLoreStat) {
            this.dynamicLores.add((DynamicLoreStat)itemStat);
        }
