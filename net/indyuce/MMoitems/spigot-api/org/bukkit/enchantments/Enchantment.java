...
public abstract class Enchantment
{
    ...
    static {
        ...
        DEPTH_STRIDER = new EnchantmentWrapper(8);
        FROST_WALKER = new EnchantmentWrapper(9);
        ...
        LUCK = new EnchantmentWrapper(61);
        LURE = new EnchantmentWrapper(62);
        MENDING = new EnchantmentWrapper(70);
