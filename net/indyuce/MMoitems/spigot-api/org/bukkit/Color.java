...
public final class Color implements ConfigurationSerializable
{
    ...
    public Color mixColors(final Color... colors) {
        ...
        final float averageRed = (float)(totalRed / (colors.length + 1));
        final float averageGreen = (float)(totalGreen / (colors.length + 1));
        final float averageBlue = (float)(totalBlue / (colors.length + 1));
        final float averageMax = (float)(totalMax / (colors.length + 1));
    ...
    public Map<String, Object> serialize() {
        return (Map<String, Object>)ImmutableMap.of("RED", Integer.valueOf(this.getRed()), "BLUE", Integer.valueOf(this.getBlue()), "GREEN", Integer.valueOf(this.getGreen()));
    }
