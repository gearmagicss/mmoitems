        ...
        if (args[0].equalsIgnoreCase("objectives")) {
            ...
            if (args[1].equalsIgnoreCase("list")) {
                ...
                if (slot == null) {
                    ...
                    final Objective objective3 = mainScoreboard.getObjective(slot);
                    if (objective3 != null) {
                        objective3.setDisplaySlot(null);
                    }
            ...
            if (args[1].equalsIgnoreCase("set") || args[1].equalsIgnoreCase("add") || args[1].equalsIgnoreCase("remove")) {
                ...
                final Objective objective = mainScoreboard.getObjective(objectiveName2);
                if (objective == null) {
                ...
                final Score score = objective.getScore(playerName);
                int newScore;
                if (args[1].equalsIgnoreCase("set")) {
                    newScore = value;
                }
                ...
                mainScoreboard.resetScores(playerName2);
                ...
                if (args.length == 2) {
                    final Set<String> entries = mainScoreboard.getEntries();
                    if (entries.isEmpty()) {
                    ...
                    final Set<Score> scores = mainScoreboard.getScores(playerName2);
                    if (scores.isEmpty()) {
            ...
            if (args[1].equalsIgnoreCase("list")) {
                ...
                if (name.length() > 16) {
                    ...
                    final Team team2 = mainScoreboard.registerNewTeam(name);
                    if (displayName2 != null && displayName2.length() > 0) {
                        team2.setDisplayName(displayName2);
                    }
                    sender.sendMessage("Added new team '" + team2.getName() + "' successfully");
                }
            }
            else if (args[1].equalsIgnoreCase("remove")) {
                if (args.length != 3) {
                ...
                if (team == null) {
                    ...
                    if (sender instanceof Player && args.length == 3) {
                        team.addPlayer((OfflinePlayer)sender);
                ...
                if (sender instanceof Player && args.length == 2) {
                    final Team team2 = mainScoreboard.getPlayerTeam((OfflinePlayer)sender);
                    if (team2 != null) {
                        team2.removePlayer((OfflinePlayer)sender);
                ...
                if (args.length == 4) {
                    ...
                    if (option.equals("color")) {
                        ...
                        if (option.equals("friendlyfire")) {
                            team.setAllowFriendlyFire(value2.equals("true"));
                        }
                        else {
                            team.setCanSeeFriendlyInvisibles(value2.equals("true"));
                        }
                    }
                    sender.sendMessage("Set option " + option + " for team " + team.getName() + " to " + value2);
                }
            }
        }
        return true;
