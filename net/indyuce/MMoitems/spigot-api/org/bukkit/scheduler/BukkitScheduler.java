...
public interface BukkitScheduler
{
    ...
    @Deprecated
    int scheduleSyncDelayedTask(final Plugin p0, final BukkitRunnable p1, final long p2);
    
    int scheduleSyncDelayedTask(final Plugin p0, final Runnable p1);
    
    @Deprecated
    int scheduleSyncDelayedTask(final Plugin p0, final BukkitRunnable p1);
    
    int scheduleSyncRepeatingTask(final Plugin p0, final Runnable p1, final long p2, final long p3);
    
    @Deprecated
    int scheduleSyncRepeatingTask(final Plugin p0, final BukkitRunnable p1, final long p2, final long p3);
    ...
    @Deprecated
    BukkitTask runTask(final Plugin p0, final BukkitRunnable p1) throws IllegalArgumentException;
    
    BukkitTask runTaskAsynchronously(final Plugin p0, final Runnable p1) throws IllegalArgumentException;
    
    @Deprecated
    BukkitTask runTaskAsynchronously(final Plugin p0, final BukkitRunnable p1) throws IllegalArgumentException;
    
    BukkitTask runTaskLater(final Plugin p0, final Runnable p1, final long p2) throws IllegalArgumentException;
    
    @Deprecated
    BukkitTask runTaskLater(final Plugin p0, final BukkitRunnable p1, final long p2) throws IllegalArgumentException;
    
    BukkitTask runTaskLaterAsynchronously(final Plugin p0, final Runnable p1, final long p2) throws IllegalArgumentException;
    
    @Deprecated
    BukkitTask runTaskLaterAsynchronously(final Plugin p0, final BukkitRunnable p1, final long p2) throws IllegalArgumentException;
    
    BukkitTask runTaskTimer(final Plugin p0, final Runnable p1, final long p2, final long p3) throws IllegalArgumentException;
    
    @Deprecated
    BukkitTask runTaskTimer(final Plugin p0, final BukkitRunnable p1, final long p2, final long p3) throws IllegalArgumentException;
    ...
    @Deprecated
    BukkitTask runTaskTimerAsynchronously(final Plugin p0, final BukkitRunnable p1, final long p2, final long p3) throws IllegalArgumentException;
}
