...
public final class Bukkit
{
    ...
    public static Player[] _INVALID_getOnlinePlayers() {
        return Bukkit.server._INVALID_getOnlinePlayers();
    }
    ...
    public static CachedServerIcon loadServerIcon(final File file) throws IllegalArgumentException, Exception {
        return Bukkit.server.loadServerIcon(file);
    }
    
    public static CachedServerIcon loadServerIcon(final BufferedImage image) throws IllegalArgumentException, Exception {
    ...
    public static BossBar createBossBar(final String title, final BarColor color, final BarStyle style, final BarFlag... flags) {
        return Bukkit.server.createBossBar(title, color, style, flags);
    }
