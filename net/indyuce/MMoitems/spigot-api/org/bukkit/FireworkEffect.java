...
public final class FireworkEffect implements ConfigurationSerializable
{
    ...
    public Map<String, Object> serialize() {
        return (Map<String, Object>)ImmutableMap.of("flicker", (Serializable)this.flicker, "trail", (Serializable)this.trail, "colors", (Serializable)this.colors, "fade-colors", (Serializable)this.fadeColors, "type", (Serializable)this.type.name());
    }
