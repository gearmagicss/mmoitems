...
public class CustomSounds extends ItemStat implements GemStoneStat, PlayerConsumable
{
    ...
    public ArrayList<ItemTag> getAppliedNBT(@NotNull final StatData statData) {
        ...
        ((SoundListData)statData).getCustomSounds().forEach(customSound -> {
            ...
            new ItemTag("MMOITEMS_SOUND_" + customSound.name(), (Object)soundData.getSound());
            list2.add(e);
            new ItemTag("MMOITEMS_SOUND_" + customSound.name() + "_VOL", (Object)soundData.getVolume());
            list2.add(e2);
            new ItemTag("MMOITEMS_SOUND_" + customSound.name() + "_PIT", (Object)soundData.getPitch());
            list2.add(e3);
            return;
        });
        return list;
