...
public class MMOUtils
{
    ...
    @Nullable
    public static UUID UUIDFromString(@org.jetbrains.annotations.Nullable final String name) {
        if (name == null) {
            return null;
        }
